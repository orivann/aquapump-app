...
const translations = {
  en: {
    ...
    "hero.metrics.energy.description":
    ...
    "hero.pills.remote.desc":
      "Secure dashboards stream live telemetry to your team.",
    "hero.pills.support.title": "White-Glove Support",
    "hero.pills.support.desc":
      "Field engineers remain on standby 24/7 worldwide.",
    ...
    "features.flow.desc":
      "Precision-engineered water flow systems for optimal performance and efficiency.",
    "features.energy.title": "Energy Efficient",
    "features.energy.desc":
      "Smart power management reduces energy consumption by up to 60%.",
    "features.eco.title": "Eco-Friendly Design",
    "features.eco.desc":
      "Sustainable materials and green technology for a better tomorrow.",
    "features.durable.title": "Built to Last",
    "features.durable.desc":
      "Premium materials ensure decades of reliable, maintenance-free operation.",
    "features.smart.title": "Smart Monitoring",
    "features.smart.desc":
      "Real-time performance tracking and intelligent diagnostics.",
    "features.install.title": "Easy Installation",
    "features.install.desc":
      "Streamlined setup process with comprehensive support.",

    // Technology
    "tech.badge": "Engineering Core",
    "tech.title": "Precision Engineering",
    "tech.intro":
      "Our water pump systems represent the pinnacle of modern engineering. Every component is meticulously designed and tested to deliver unparalleled performance, efficiency, and reliability.",
    ...
    "sustain.intro":
      "At AquaPump, we believe in creating solutions that don't just serve today's needs, but protect tomorrow's world. Our eco-friendly technology reduces environmental impact while delivering superior performance.",
    ...
    "products.configureSubtitle":
      "Share flow targets and site constraints — our engineers reply with a tuned bill of materials within one business day.",
    ...
    "chatbot.description":
      "Aqua AI handles inbound questions, technical clarifications, and project discovery so your team can focus on closing deals. Conversations persist automatically and can hand off to humans at any time.",
    "chatbot.cta": "Chat with Aqua AI",
    "chatbot.secondaryCta": "Talk to sales",
    "chatbot.highlight.instant.title": "Instant expertise",
    "chatbot.highlight.instant.desc":
      "Get immediate answers about product specs, configurations, and ROI calculations.",
    "chatbot.highlight.reliable.title": "Reliable guidance",
    "chatbot.highlight.reliable.desc":
      "Responses are grounded in curated AquaPump knowledge and best practices.",
    "chatbot.highlight.available.title": "Always available",
    "chatbot.highlight.available.desc":
      "Engage prospects 24/7 and capture context for seamless human follow-up.",
    ...
    "contact.intro":
      "Ready to transform your water management? Our team is here to help you find the perfect solution for your needs.",
    "contact.phone": "Phone",
    "contact.email": "Email",
  ...
  he: {
    ...
    "hero.subtitle":
      "המשאבה שלך, הפתרון שלנו — מערכות משאבות מים פרימיום, בנות קיימא וידידותיות לסביבה",
    ...
    "features.subtitle":
      "תכונות מתקדמות שתוכננו ליעילות, קיימות וביצועים מקסימליים",
    "features.flow.title": "טכנולוגיית זרימה מתקדמת",
    "features.flow.desc":
      "מערכות זרימת מים מהונדסות בדיוק לביצועים ויעילות אופטימליים.",
    "features.energy.title": "יעילות אנרגטית",
    "features.energy.desc":
      "ניהול חכם של צריכת חשמל מפחית את צריכת האנרגיה עד 60%.",
    ...
    "features.durable.desc":
      "חומרים פרימיום מבטיחים עשרות שנים של תפעול אמין וללא תחזוקה.",
    ...
    "tech.intro":
      "מערכות המשאבות שלנו מייצגות את שיא ההנדסה המודרנית. כל רכיב מתוכנן ונבדק בקפידה כדי לספק ביצועים, יעילות ואמינות ללא תחרות.",
    "tech.materials.title": "חומרים מתקדמים",
    "tech.materials.desc":
      "סגסוגות עמידות בפני קורוזיה מבטיחות עשרות שנים של פעולה ללא תחזוקה",
    ...
    "products.subtitle":
      "ממגורים לתעשייה, גלה את פתרון משאבת המים המושלם לצרכים שלך",
    ...
    "chatbot.description":
      "Aqua AI מטפל בשאלות נכנסות, בהבהרות טכניות ובאיסוף צרכים כך שהצוות שלכם יכול להתמקד בסגירת עסקאות. השיחות נשמרות אוטומטית וניתנות להעברה חלקה לנציג אנושי בכל שלב.",
    "chatbot.cta": "דברו עם Aqua AI",
    "chatbot.secondaryCta": "דברו עם המכירות",
    "chatbot.highlight.instant.title": "מומחיות מיידית",
    "chatbot.highlight.instant.desc":
      "קבלו תשובות מידיות על מפרטי מוצר, תצורות וחישובי ROI.",
    "chatbot.highlight.reliable.title": "הכוונה אמינה",
    "chatbot.highlight.reliable.desc":
      "התשובות מבוססות על הידע המסונן של AquaPump ועל שיטות עבודה מומלצות.",
    "chatbot.highlight.available.title": "זמין תמיד",
    "chatbot.highlight.available.desc":
      "העוזר זמין 24/7 ושומר הקשר להמשך טיפול אנושי חסר מאמץ.",
    ...
    "contact.intro":
      "מוכנים לשנות את ניהול המים שלכם? הצוות שלנו כאן כדי לעזור לכם למצוא את הפתרון המושלם לצרכים שלכם.",
    "contact.phone": "טלפון",
